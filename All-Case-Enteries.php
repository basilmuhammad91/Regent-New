...
if(isset($_POST['submit']))
{
    ...
    $query = mysqli_query($con, "
        INSERT INTO `cases`(`user_id`, `agency_id`, `visa_no`, `visa_id_no`, `visa_sponsor_name`, `visa_date`, `visa_profession_id`, `visa_price_as_per_agency`, `visa_price_as_per_regent`, `passenger_name`, `passenger_father_name`, `passenger_eno`, `passenger_passport_no`, `passenger_dob`, `passenger_name_urdu`, `passenger_father_name_urdu`, `passenger_date_of_issue`, `passenger_date_of_expiry`, `passenger_submit_date`, `submitted_to`, `visa_status_id`, `visa_courier_date`, `visa_courier_name`, `visa_courier_no`, `remarks`, `current_date_submission`, `type`) VALUES (

            '$user_id', '$agency_id', '$visa_no', '$visa_id_no', '$visa_sponsor_name', '$visa_date', '$visa_profession_id', '$visa_price_as_per_agency', '$visa_price_as_per_regent', '$passenger_name', '$passenger_father_name', '$passenger_eno', '$passenger_passport_no', '$passenger_dob', '$passenger_name_urdu', '$passenger_father_name_urdu', '$passenger_date_of_issue', '$passenger_date_of_expiry', '$passenger_submit_date', '$submitted_to', '$visa_status_id', '$visa_courier_date', '$visa_courier_name', '$visa_courier_no', '$remarks', '$current_date_submission', '$type'
                ...
                <tr>
                     ...
                     <div class="dropdown">
                            ...
                            <div class="dropdown-menu fadeInUp animated faster pl-2" id="table-dropdown" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a style="font-size: 13px; font-weight: bold;" href="Visa-Form.php" class="btn text-light bg-warning p-1 ">Permission Form</a> <br>
