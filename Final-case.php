	...
	<section class="container-fluid">
		...
		<section class="row">
			<section class="col-xl-2">
						<input type="text" class="form-control input-box" placeholder="File No." maxlength="5">
			</section>
			<section class="col-xl-2">
						<input type="text" class="form-control input-box" placeholder="Passport No." maxlength="5">
			</section>
			<section class="col-xl-2">
...
<br>
		<section class="row">
			<section class="col-xl-2">
						<input type="text" class="form-control input-box" placeholder="As Per Agency Price." maxlength="5">
			</section>

			<section class="col-xl-2">
						<input type="text" class="form-control input-box" placeholder="As Per Regent Price." maxlength="5">
			</section>
		</section>
...
<section class="row">
			...
			<section class="col-xl-2">
						<input type="text" class="form-control input-box" placeholder="Agency" maxlength="5">
			</section>
			<section class="col-xl-2">
						<input type="text" class="form-control input-box" placeholder="Regent" maxlength="5">
			</section>
