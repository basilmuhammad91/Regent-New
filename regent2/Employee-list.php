            ...
            <table class="table m-auto ">
                ...
                <thead>
                  ...
                  <tbody>
                   ...
                   <?php
                   $query = mysqli_query($con, "select * from users where role = 'Employee'");
                             ...
                             <td><?php echo $row['role'] ?></td>
                              ...
                              <td >
                                <div class="dropdown show">
                                  ...
                                  <!-- <center>
                                      <button class="btn bg-primary text-light" ><i class="fas fa-edit" style="font-size: 10px; transform: scale(1.5);"></i></button>
                                      <button class="btn bg-danger text-light" ><i class="fas fa-remove" style="font-size: 15px;"></i></button>
